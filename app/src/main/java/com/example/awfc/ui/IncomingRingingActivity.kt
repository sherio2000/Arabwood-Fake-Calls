...
@AndroidEntryPoint
class IncomingRingingActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIncomingRingingBinding.inflate(layoutInflater)
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@IncomingRingingActivity.cameraDevice = cameraDevice
            startPreview()
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@IncomingRingingActivity.cameraDevice = null
        }
    ...
    private fun setUpMediaRecorder() {
        val cameraActivity = this ?: return
